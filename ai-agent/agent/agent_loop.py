...
class BillerQAgent:
    ...
    async def run(self, message: str, context: dict = None, billerq_token: str = "", billerq_api_url: str = "", billerq_user_role: int | None = None) -> tuple[str, dict]:
        ...
        try:
            ...
            navigation_mappings = {
                ...
                # Lead Manager
                ("enquiry", "enquiries"): ("/lead-manager/enquiry", "Lead Manager > Enquiries"),
                ("lead", "leads"): ("/lead-manager/leads", "Lead Manager > Leads"),
                ("follow up", "follow ups", "follow-up", "follow-ups"): ("/lead-manager/follow-ups", "Lead Manager > Follow-Ups"),
                ("overdue", "overdues"): ("/lead-manager/overdues", "Lead Manager > Overdues"),
                ...
                ("stb", "modem", "stbs", "modems", "stb / modem"): ("/customers/stb-modem", "Customers > STB / Modem"),
                ...
                ("activate subscription", "activate subscriptions"): ("/billing/activate-subscription", "Billing > Activate Subscription"),
                ...
                # Services / Products
                ("package", "packages"): ("/services/packages", "Services / Products > Packages"),
                ("addon", "addons"): ("/services/addons", "Services / Products > Addons"),
                ("item", "items"): ("/services/items", "Services / Products > Items"),
                
                # Expenses & Income
                ("expense", "expenses"): ("/expenses/expenses", "Expenses & Income > Expense"),
                ("income", "incomes"): ("/expenses/income", "Expenses & Income > Income"),
                ("header", "headers", "expense header", "expense headers"): ("/expenses/header", "Expenses & Income > Header"),
                ("vendor", "vendors"): ("/expenses/vendor", "Expenses & Income > Vendor"),
                ...
                ("sms logs", "sms log"): ("/report/sms-logs", "Reports > SMS Logs"),
                ("whatsapp logs", "whatsapp log"): ("/report/whatsapp-logs", "Reports > WhatsApp Logs"),
                ...
                # Complaints
                ("complaint list", "complaint", "complaints", "problems"): ("/complaints", "Complaints > Complaint List"),
                
                # Staff
                ("staff", "staffs", "user", "users"): ("/menu/user", "Staff > User"),
                ("role", "roles"): ("/menu/role", "Staff > Role"),
    ...
    def _get_redirect_metadata(self, tool_name: str, resolved_cust_id: int = None, resolved_cust_name: str = None, message_str: str = "", resolved_agent_id: int = None) -> dict:
        ...
        tool_map = {
            ...
            "get_packages": ("/services/packages", "View Packages"),
            "get_areas": ("/settings/area", "View Areas"),
            "get_stb_status_count": ("/customers/stb-modem", "View STBs"),
            "get_stbs": ("/customers/stb-modem", "View STBs"),
            "get_enquiries": ("/lead-manager/enquiry", "View Enquiries"),
            "get_leads": ("/lead-manager/leads", "View Leads"),
            "get_followups": ("/lead-manager/follow-ups", "View Follow-Ups"),
            "get_accounts": ("/banking/account", "View bank accounts"),
            "get_transactions": ("/banking/transaction", "View banking transactions"),
            "get_expenses": ("/expenses/expenses", "View Expenses"),
            "get_incomes": ("/expenses/income", "View Income"),
            "get_headers": ("/expenses/header", "View Headers"),
            "get_vendors": ("/expenses/vendor", "View Vendors"),
            "get_sms_logs": ("/report/sms-logs", "View SMS Logs"),
            "get_whatsapp_logs": ("/report/whatsapp-logs", "View WhatsApp Logs"),
            "get_items": ("/services/items", "View Items"),
            "get_both_subscription_addon": ("/services/addons", "View Addons"),
            "get_staff": ("/menu/user", "View Staff"),
            "get_roles": ("/menu/role", "View Roles"),
